---
title: Betacap Scalp Taper Journal
created: 2026-04-21
tags: [health, psoriasis, journal]
publish_date: 2026-04-21
---

# Betacap Scalp Taper Journal

> **Treatment:** Betacap (betamethasone valerate 0.1% scalp application)
> **Condition:** Scalp psoriasis
> **Goal:** Taper off steroid without rebound flare

---

## Taper Plan

| Phase | Schedule | Duration | Status |
|-------|----------|----------|--------|
...
**Rules:**
- Stay at each phase until **stable for 2+ weeks** (no new plaques, no increasing redness/itch, no thick scale)
- If flare returns → step back to previous phase for 1–2 weeks, then retry
- Contact GP if not cleared or worsens after 4 weeks at any phase
...
- No new plaques, no thick scale
- Next dose: 2026-04-30 (tomorrow)

### 2026-04-27 — Phase 3, Dose 3
- Applied Betacap tonight
- Scalp state: stable, dandruffy
- No redness or itch reported
...
- Ready to stretch to every 3 days
- Will watch closely for any return of redness, thick scale, or itch

---

## Warning Signs to Watch For

Step back to previous phase if any of these appear:
- [ ] New red plaques or patches
- [ ] Increasing scale thickness
- [ ] Return of significant itch
- [ ] Spread beyond current areas
